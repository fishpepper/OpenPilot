...
/*
   ...
   ------+-----------+-----------+-----------+----------
   TIM1  |  RC In 5  |           |           |  RC In 6
   TIM2  |  RC In 1  |  RC In 2  |  RC In 3  |  RC In 4
   TIM3  |  (Servo5) | (Servo6)  |  MOTOR 3  |  MOTOR 4
   TIM4  |           |           |  MOTOR 1  |  MOTOR 2
   ------+-----------+-----------+-----------+----------

   Servo5 and Servo6 Outputs are deactivated (set to input with pulldown GPIO_Mode_IPD)
 */
...
extern uint32_t pios_i2c_mpu6000_adapter_id;
#define PIOS_I2C_MAIN_ADAPTER    (pios_i2c_mpu6000_adapter_id)
...
// strangely this has always to be defined... otherwise gps config will crash
...
// Servo outputs
// -------------------------
#define PIOS_SERVO_BRUSHED_MOTORS    1
