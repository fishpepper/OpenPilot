...
#define BOARD_REVISION_CJMCU 0x07

#if defined(PIOS_INCLUDE_LED)

#include <pios_led_priv.h>
static const struct pios_gpio pios_leds_cjmcu[] = {
    [PIOS_LED_HEARTBEAT] = {
        .pin                =             {
            .gpio = GPIOC,
            .init =             {
...
static const struct pios_gpio_cfg pios_led_cfg_cjmcu = {
    .gpios     = pios_leds_cjmcu,
    .num_gpios = NELEMENTS(pios_leds_cjmcu),
};

const struct pios_gpio_cfg *PIOS_BOARD_HW_DEFS_GetLedCfg(__attribute__((unused)) uint32_t board_revision)
{
    return &pios_led_cfg_cjmcu;
}
...
static const struct flashfs_logfs_cfg flashfs_internal_cfg = {
    ...
    .sector_size   = 0x00008000, /* 16K bytes */
    .page_size     = 0x00008000, /* 16K bytes */
};
...
static const struct pios_tim_channel pios_tim_servoport_all_pins[] = {
...

    {
        ...
        .pin   = {
            ...
            .init = {
                .GPIO_Pin   = GPIO_Pin_6,
                .GPIO_Mode  = GPIO_Mode_IPD, // DISABLED!
                .GPIO_Speed = GPIO_Speed_2MHz,
            },
        },
    },
...
// we redirect the gcs link to the not used usart3 when we enable debugging...
static const struct pios_usart_cfg pios_usart_generic_not_connected_cfg = {
    .regs = USART3,
    .init = {
        .USART_BaudRate   = 57600,
        .USART_WordLength = USART_WordLength_8b,
...
void PIOS_I2C_mpu6000_adapter_ev_irq_handler(void);
void PIOS_I2C_mpu6000_adapter_er_irq_handler(void);

void I2C1_EV_IRQHandler()
__attribute__((alias("PIOS_I2C_mpu6000_adapter_ev_irq_handler")));
void I2C1_ER_IRQHandler()
__attribute__((alias("PIOS_I2C_mpu6000_adapter_er_irq_handler")));

static const struct pios_i2c_adapter_cfg pios_i2c_mpu6000_adapter_cfg = {
    .regs = I2C1,
    .init = {
...
uint32_t pios_i2c_mpu6000_adapter_id;
void PIOS_I2C_mpu6000_adapter_ev_irq_handler(void)
{
    /* Call into the generic code to handle the IRQ for this specific device */
    PIOS_I2C_EV_IRQ_Handler(pios_i2c_mpu6000_adapter_id);
}

void PIOS_I2C_mpu6000_adapter_er_irq_handler(void)
{
    /* Call into the generic code to handle the IRQ for this specific device */
    PIOS_I2C_ER_IRQ_Handler(pios_i2c_mpu6000_adapter_id);
}
